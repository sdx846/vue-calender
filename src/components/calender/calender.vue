    ...
    <div class="head">
      <slot name="header">
        <div class="head-content">
          <img src="../../assets/left.png" @click="toMonth('pre')" />
          <div class="head-text">
            {{ dateText }}
          </div>
          <img src="../../assets/right.png" @click="toMonth('next')" />
        </div>
      </slot>
    </div>
    <div class="week-text">
...
export default {
  ...
  data() {
    return {
      ...
      downImg: require("../../assets/slide_down.png"),
      upImg: require("../../assets/slide_up.png"),
      defImg: require("../../assets/slide_def.png"),
      slideStatus: "def",
    };
  },
  created() {
  ...
  methods: {
    ...
    selDate(item) {
      if (this.isHideDate(item) || this.isDisableDate(item.date) || this.readOnly) return;
